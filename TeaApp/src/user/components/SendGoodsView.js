...
import styles from "../styles/SendGoodsStyle";
import HeadView from '../../common/components/HeadView';
import AddressView from "../../common/components/AddressView";
import WuliuView from "../components/WuliuView";
export default class SendGoodsView extends React.Component {
    render() {
        return (
            <View style={styles.container}>
                <HeadView navigator={this.props.navigator} name="待发货" />
                <ScrollView style={styles.scroll}>
                    <View style={styles.news}>
                        <Image style={styles.clock} source={require("../image/pay/clock.png")} />
                        <Text style={styles.notice}>等待发货中</Text>
                        <Text style={styles.xiaoer}>(小二正在为您挑选商品哦~)</Text>
                    </View>
                ...
                <View style={styles.remind}>
                    <Text style={styles.remindText}>提醒发货</Text>
                </View>
            </View>
        )
    }
