...
import styles from "../styles/ReceiveStyle";
    ...
    render() {
        return (
            <View style={styles.container}>
                <HeadView navigator={this.props.navigator} name="待收货" />
                <ScrollView style={styles.scroll}>
                    <View style={styles.news}>
                        <Image style={styles.clock} source={require("../image/pay/clock.png")} />
                        <Text style={styles.notice}>等待您的收货</Text>
                        <Text style={styles.xiaoer}>(三天之后自动收货)</Text> 
                    </View>
                ...
                <View style={styles.remind}>
                    ...
                    <Text style={styles.remindText}>确认收货</Text>
                </View>
            </View>
        )
    }
