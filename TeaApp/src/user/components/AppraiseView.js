...
import styles from "../styles/AppraiseStyle";
...
export default class AppraiseView extends React.Component {
    render() {
        return (
            <View style={styles.container}>
                <HeadView navigator={this.props.navigator} name="待评价" />
                <ScrollView style={styles.scroll}>
                    <View style={styles.news}>
                        <Image style={styles.clock} source={require("../image/pay/clock.png")} />
                        <Text style={styles.notice}>商品已送达</Text>
                        <Text style={styles.xiaoer}>(亲!给个好评吧!么么哒~)</Text> 
                    </View>
                    ...
                    <View style={styles.logistics}>
                        ...
                        <View style={styles.logiText}>
                            ...
                            <Text style={styles.logi2}>已签收，本人签收</Text>
                    ...
                    <View style={styles.order}>
                        ...
                        <View style={styles.orderText}>
                            <View style={styles.state}>
                                ...
                                <Text style={styles.state2}>已签收，待评价
                                </Text>
                            </View>
                            <View style={styles.state}>
                ...
                <View style={styles.remind}>
                    <Text style={styles.remindText} onPress={()=>{
                        this.props.navigator.push({
                            params:{naem:"confirmOrder"},
                            component:confirmOrderView
                        })
                    }}>再来一单</Text>
                    <Text style={styles.remindText}>评价</Text>
                </View>
            </View>
        )
    }
